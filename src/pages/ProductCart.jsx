  ...
  return (
    <>
      ...
      <div className="bg-[#f5f5f5] w-full pt-4">
        <div className="mx-24 bg-white mt-24 flex flex-col">
          <div data-aos="fade-up" className="w-full px-8 bg-white">
            <div className="flex">
              <div className='w-1/2 font-bold text-gray-600 tracking-wider'>MEU CARRINHO</div>
            ...
            <div data-aos="fade-up" className="flex items-center mt-4">
              <div className="w-1/2 flex justify-between h-56 items-center">
                <div className='flex justify-center items-center h-40 w-56 bg-blue-100 rounded-lg'>
                  <img src={fotoSapato} alt="fotosapato" className='h-14' />
                </div>
                ...
                <div className="flex flex-col gap-4 ml-8">
                  <div className='flex flex-col h-40 justify-between gap-4'>
                    ...
                    <div className="divCores flex">
                      ...
                      <div className="tipoDeCor">Vermelho / branco</div>
                    </div>
            ...
            <div data-aos="fade-up" className="divInfoAdicional flex gap-10 mt-4">
          ...
          <Resumo data-aos="fade-up" className="mt-8" />
        </div>

        <div data-aos="fade-up" className="flex justify-between mt-40">
